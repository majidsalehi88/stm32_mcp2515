...
uint8_t CANSPI_Initialize(void)
{
  ...
  /* Filter & Mask 값 설정 */
  MCP2515_WriteByteSequence(MCP2515_RXM0SIDH, 1, 0x00);
  MCP2515_WriteByteSequence(MCP2515_RXM1SIDH, 1, 0x00);
  MCP2515_WriteByteSequence(MCP2515_RXF0SIDH, 1, 0x00);
  MCP2515_WriteByteSequence(MCP2515_RXF1SIDH, 0, 0x00);
  MCP2515_WriteByteSequence(MCP2515_RXF2SIDH, 1, 0x00);
  MCP2515_WriteByteSequence(MCP2515_RXF3SIDH, 0, 0x00);
  MCP2515_WriteByteSequence(MCP2515_RXF4SIDH, 1, 0x00);
  MCP2515_WriteByteSequence(MCP2515_RXF5SIDH, 0, 0x00);
